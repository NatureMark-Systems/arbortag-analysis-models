...
# Load your data
file_path = '/home/saif/Pytest/gps_test9.csv'  # Replace with the path to your CSV file
...
# Save the figure
plt.savefig('/home/saif/Pytest/summary_table.png', bbox_inches='tight', dpi=300)
plt.show()
